...
use Mmucha1\ExampleMenuBundle\Form\MenuType;
...
class MenuController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('Mmucha1ExampleMenuBundle:Menu')->findAll();
     ...
     * @Method("POST")
     * @Template("Mmucha1ExampleMenuBundle:Menu:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('Mmucha1ExampleMenuBundle:Menu')->find($id);
     ...
     * @Method("PUT")
     * @Template("Mmucha1ExampleMenuBundle:Menu:edit.html.twig")
     */
